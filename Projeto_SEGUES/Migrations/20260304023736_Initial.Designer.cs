...
namespace Projeto_SEGUES.Migrations
{
    ...
    [Migration("20260304023736_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Projeto_SEGUES.Models.Order.BalanceOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("BalanceOrders");
                });

            modelBuilder.Entity("Projeto_SEGUES.Models.Order.Discount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Projeto_SEGUES.Models.Order.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Projeto_SEGUES.Models.Order.OrderLine", b =>
                {
            ...
            modelBuilder.Entity("Projeto_SEGUES.Models.Inventory.Product", b =>
                {
                    ...
                    b.HasOne("Projeto_SEGUES.Models.Order.Discount", null)
                        .WithMany("Products")
            ...
            modelBuilder.Entity("Projeto_SEGUES.Models.Order.Order", b =>
                {
                    ...
                    b.HasOne("Projeto_SEGUES.Models.Order.Discount", "Discount")
                        .WithMany()
                        .HasForeignKey("DiscountId");
            ...
            modelBuilder.Entity("Projeto_SEGUES.Models.Order.OrderLine", b =>
                {
                    ...
                    b.HasOne("Projeto_SEGUES.Models.Order.Order", "Order")
