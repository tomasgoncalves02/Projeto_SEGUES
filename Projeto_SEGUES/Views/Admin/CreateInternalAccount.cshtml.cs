...
namespace Projeto_SEGUES.Views.Admin
{
    public class CreateInternalAccountModel : PageModel
    {
        ...
        public CreateInternalAccountModel(UserManager<User> userManager, IEmailSender emailSender)
        {
        ...
        [BindProperty]
        public CreateInternalUserViewModel Input { get; set; }
