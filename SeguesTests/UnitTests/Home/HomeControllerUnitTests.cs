...
public class HomeControllerUnitTests
{
    ...
    public HomeControllerUnitTests()
    {
        ...
        _controller = new HomeController(mockLogger.Object, _mockUserManager.Object, _mockAdminService.Object, _mockOrderService.Object);
    ...
    public async Task Index_AuthenticatedUser_ReturnsViewWithDashboardData()
    {
        ...
        var claims = new List<Claim> { new(ClaimTypes.Name, "pedro@segues.pt") };
