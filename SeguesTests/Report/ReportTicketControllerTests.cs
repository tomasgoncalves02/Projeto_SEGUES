...
public class ReportTicketControllerTests
{
    private readonly Mock<ITicketService> _mockTicketService;
    private readonly Mock<UserManager<AppUser>> _mockUserManager;
    private readonly ReportTicketController _controller;
    private readonly Mock<ILogger<ReportTicketController>> _mockLogger;

        
    public ReportTicketControllerTests()
    {
        _mockTicketService = new Mock<ITicketService>();
        var store = new Mock<IUserStore<AppUser>>();
        _mockUserManager = new Mock<UserManager<AppUser>>(store.Object, null, null, null, null, null, null, null, null);
        _mockLogger = new Mock<ILogger<ReportTicketController>>();

        _controller = new ReportTicketController(_mockTicketService.Object);
...
/*
    ...
    public async Task Index_AuthenticatedUser_ReturnsViewWithFilters()
    {
        ...
        var result = await _ticketController.Index("search", TicketState.Available, "buy", null);

        var viewResult = Assert.IsType<ViewResult>(result);
        Assert.Equal("search", _ticketController.ViewData["CurrentSearch"]);
        Assert.Equal(TicketState.Available, _ticketController.ViewData["CurrentState"]);
        Assert.Equal(user.Id, _ticketController.ViewBag.CurrentUserId);
    }
    ...
    public async Task Index_UserNotFound_ReturnsChallenge()
    {
        ...
        var result = await _ticketController.Index(null, null, null, null);
    ...
    public async Task GetFilteredHistory_ValidEnum_ReturnsPartialView()
    {
        ...
        var result = await _ticketController.GetFilteredHistory("Used", null, "all", "");
    ...
    public async Task GetFilteredHistory_InvalidEnum_CallsServiceWithNullState()
    {
        ...
        await _ticketController.GetFilteredHistory("InvalidStateName", null, "all", "");
    ...
    public async Task Index_VerifiesDateFilterPersistence()
    {
        ...
        var result = await _ticketController.Index(null, null, null, testDate);

        var viewResult = Assert.IsType<ViewResult>(result);
        Assert.Equal(testDate, _ticketController.ViewData["CurrentDate"]);
    }
    ...
    public async Task GetFilteredHistory_VerifiesExactMappingToService()
    {
        ...
        await _ticketController.GetFilteredHistory("Available", date, flow, search);
