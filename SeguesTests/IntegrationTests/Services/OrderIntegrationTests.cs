...
public class OrderIntegrationTests
{
    ...
    private static AppUser CreateValidPedro(string id, decimal balance = 100m) => new()
    {
        Id = id,
        FirstName = "Pedro",
    ...
    private static Product CreateValidProduct(int id, string name, decimal price, int stock) => new()
    {
        Id = id,
        Name = name,
        Price = price,
